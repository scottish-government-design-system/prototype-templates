...
var interval = window.setInterval(function() {
    if (window.DS) {
      var datepicker = new window.DS.components.DSDatePicker(document.querySelector('[data-module="ds-datepicker"]'), {
        imagePath: '/node_modules/@scottish-government/design-system/dist/images/icons/'
      });
      datepicker.init();
      clearInterval(interval);
    }
